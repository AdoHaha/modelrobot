...
(function() {
  ...
  App.AllRobots = (function(_super) {
    __extends(AllRobots, _super);
  ...
  App.AllCSVs = (function(_super) {
    __extends(AllCSVs, _super);
  ...
  App.RobotURDF = (function(_super) {
    __extends(RobotURDF, _super);
  ...
  App.RobotForm = (function(_super) {
    ...
    RobotForm.prototype.newRobot = function() {
      ...
      window.parseRobot(this.model.attributes.urdf);
      App.setupGui();
      App.animate();
